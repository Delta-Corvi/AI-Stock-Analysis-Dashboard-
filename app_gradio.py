...
class GradioInterface:
    ...
    def create_interface(self):
        ...
        # NOTE: In Gradio 6.0+, css is passed to launch(), not Blocks()
        custom_css = """
        .gradio-container {
        ...
        # css is no longer a parameter of gr.Blocks() in Gradio 6.0 — it is passed to launch()
        with gr.Blocks(title="🚀 AI Stock Analysis Dashboard") as demo:
            # Header
            gr.HTML("""
...
if __name__ == '__main__':
    ...
    demo, custom_css = interface.create_interface()
    # css is now passed to launch() in Gradio 6.0+
